...
contract MyNFTGovernor is Governor, GovernorCompatibilityBravo, GovernorVotesComp, GovernorTimelockCompound {
    //@param {token} : if provide the ERC721 that erc721 need to support something link ERC20Votes with getVotes public function
